      ...
      <div class="shell shell-wide footer-shell">
        ...
        <div class="footer-columns">
          <div class="footer-column">
            <h2><i class="fas fa-wand-sparkles" aria-hidden="true"></i><span>Stranice</span></h2>
            <a href="index.html">Početna</a>
            <a href="about.html">O nama</a>
            <a href="services.html">Usluge</a>
            <a href="works.html">Naši radovi</a>
          ...
          <div class="footer-column">
            <h2><i class="fas fa-phone-alt" aria-hidden="true"></i><span>Kontakt</span></h2>
          ...
          <div class="footer-column">
            <h2><i class="far fa-clock" aria-hidden="true"></i><span>Radno vreme</span></h2>
